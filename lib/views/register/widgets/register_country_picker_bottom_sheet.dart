...
registerCountryPickerBottomSheet(BuildContext context) {
          ...
          children: [
            Row(
              children: [
                Expanded(
                  child: TextFormField(
                    controller: registerCountryPickerController.searchController,
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemCount: registerCountryPickerController.flagsImageList.length,
                itemBuilder: (context, index) {
                  return GestureDetector(
                    onTap: () {
                      registerCountryPickerController.selectCountry(index);
                      Get.back();
                    },
                    child: Row(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(registerCountryPickerController.flagsImageList[index]),
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              "${registerCountryPickerController.countries[index][AppString.namePicker]}",
                              style: AppStyle.heading4Regular(color: AppColor.textColor),
                            ),
                            Text(
                              "${registerCountryPickerController.countries[index][AppString.codeText]}",
