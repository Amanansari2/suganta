...
class PostProjectEditImage extends StatelessWidget {
  final ProjectPostEditProjectController projectPostEditProjectController =
      Get.find<ProjectPostEditProjectController>();

  PostProjectEditImage({super.key}) {
    final ProjectPostModel? projectData = Get.arguments;
    if (projectData != null) {}
  }
              ...
              children: [
                ...
                Align(
                        ...
                        child: Padding(
                          ...
                          child: CommonButton(
                            onPressed: () async {
                              await projectPostEditProjectController
                                  .submitEditProjectDetailsStep4Images(
                                      selectedImages);
                              if (projectPostEditProjectController
                            ...
                            child: projectPostEditProjectController
              ...
              children: [
                ...
                Divider(
                  ...
                  color: AppColor.descriptionColor.withOpacity(0.5),
                    ...
                    bottom: AppSize.appSize10),
                Obx(() {
                  final validImages = projectPostEditProjectController
                      .alreadyUploadedProjectImageUrls
                      .where((img) => img.images.isNotEmpty)
                      .toList();
                  ...
                  return Column(
                    children: [
                      Wrap(
                        spacing: 25,
                        runSpacing: 20,
                        children: projectPostEditProjectController
                            .alreadyUploadedProjectImageUrls
                            .map((img) {
                          final fullImagePath =
                          ...
                          return Stack(
                            children: [
                              ...
                              Obx(() => projectPostEditProjectController
                                      .isSelecting.value
                                  ? Positioned(
                                      top: 1,
                                      right: 1,
                                      child: Transform.scale(
                                        ...
                                        child: Checkbox(
                                          value:
                                              projectPostEditProjectController
                                                  .selectedProjectImageIds
                                                  .contains(img.id),
                                          onChanged: (value) {
                                            if (value == true) {
                                              projectPostEditProjectController
                ...
                Row(
                  ...
                  children: [
                    Obx(() => ElevatedButton(
                          onPressed: () {
                            projectPostEditProjectController.isSelecting.value =
                                !projectPostEditProjectController
                                    .isSelecting.value;
                            if (!projectPostEditProjectController
                                .isSelecting.value) {
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: projectPostEditProjectController
                                    .isSelecting.value
                                ? AppColor.red
                    ...
                    Obx(() => projectPostEditProjectController.isSelecting.value
                        ? ElevatedButton(
                            onPressed: projectPostEditProjectController
                                    .selectedProjectImageIds.isNotEmpty
                                ? () async {
                                    AppLogger.log(
                                        "Deleting images with IDs: $projectPostEditProjectController.selectedImageIds");
                                    await projectPostEditProjectController
                                        .deleteSelectedImages();

                                    if (projectPostEditProjectController
                                        .selectedProjectImageIds.isEmpty) {
                                      Get.find<HomeController>()
                                          .fetchPostPropertyList();
                                      Get.find<HomeController>()
                                          .fetchPostProjectListing();
