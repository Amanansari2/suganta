...
editCountryPickerBottomSheet(BuildContext context) {
          ...
          children: [
            Row(
              children: [
                Expanded(
                  child: TextFormField(
                    controller: editCountryPickerController.searchController,
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                    onTap: () {
                      editCountryPickerController.selectCountry(index);
                      Get.back();
                    },
                    child: Row(
                      children: [
