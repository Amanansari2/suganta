...
editSecondCountryPickerBottomSheet(BuildContext context) {
  EditCountryPickerController editCountryPickerController = Get.put(EditCountryPickerController());
          ...
          children: [
            Row(
              children: [
                Expanded(
                  child: TextFormField(
                    controller: editCountryPickerController.search2Controller,
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemCount: editCountryPickerController.flagsImageList.length,
                itemBuilder: (context, index) {
                  return GestureDetector(
                    onTap: () {
                      editCountryPickerController.select2Country(index);
                      Get.back();
                    },
                    child: Row(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(editCountryPickerController.flagsImageList[index]),
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              "${editCountryPickerController.countries[index][AppString.namePicker]}",
                              style: AppStyle.heading4Regular(color: AppColor.textColor),
                            ),
                            Text(
                              "${editCountryPickerController.countries[index][AppString.codeText]}",
