...
import '../../controller/show_property_details_controller.dart';
...
class ShowPropertyDetailsView extends StatelessWidget {
  ...
  ShowPropertyDetailsController showPropertyDetailsController = Get.put(ShowPropertyDetailsController());

  @override
  Widget build(BuildContext context) {
    showPropertyDetailsController.isSimilarPropertyLiked.value = List<bool>.generate(
        showPropertyDetailsController.searchImageList.length, (index) => false);
    return Scaffold(
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style:
                  AppStyle.heading4SemiBold(color: AppColor.whiteColor),
                ),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: List.generate(
                      showPropertyDetailsController.keyHighlightsTitleList.length,
                          (index) {
                        return Row(
                          children: [
                            Container(
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              padding: const EdgeInsets.only(left: AppSize.appSize16),
              itemCount:
              showPropertyDetailsController.furnishingDetailsImageList.length,
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              scrollDirection: Axis.horizontal,
              padding: const EdgeInsets.only(left: AppSize.appSize16),
              itemCount: showPropertyDetailsController.facilitiesImageList.length,
              itemBuilder: (context, index) {
                return Container(
                  margin: const EdgeInsets.only(right: AppSize.appSize16),
                  padding: const EdgeInsets.only(
                  ...
                  child: Column(
                    ...
                    children: [
                      Image.asset(
                        showPropertyDetailsController.facilitiesImageList[index],
                        width: AppSize.appSize40,
                      ),
                      Text(
                        showPropertyDetailsController.facilitiesTitleList[index],
                        style: AppStyle.heading5Regular(
                            color: AppColor.textColor),
                      ),
                    ],
          ...
          CommonTextField(
            ...
            readOnly: true,
            border: Border.all(
              color: AppColor.primaryColor.withOpacity(AppSize.appSizePoint50),
            ...
            textfieldStyle: AppStyle.heading4Regular(
              color: AppColor.textColor.withOpacity(AppSize.appSizePoint50),
            ),
          ).paddingOnly(
            top: AppSize.appSize16,
          ...
          Obx(() => Container(
            padding:  EdgeInsets.only(
              top: showPropertyDetailsController.hasPhoneNumberFocus.value || showPropertyDetailsController.hasPhoneNumberInput.value
                  ? AppSize.appSize6 : AppSize.appSize14,
              bottom: showPropertyDetailsController.hasPhoneNumberFocus.value || showPropertyDetailsController.hasPhoneNumberInput.value
            ...
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(AppSize.appSize12),
              border: Border.all(
                color: showPropertyDetailsController.hasPhoneNumberFocus.value || showPropertyDetailsController.hasPhoneNumberInput.value
                    ? AppColor.primaryColor.withOpacity(AppSize.appSizePoint50)
                    : AppColor.descriptionColor.withOpacity(AppSize.appSizePoint50),
                width: AppSize.appSizePoint7,
              ),
            ),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                showPropertyDetailsController.hasPhoneNumberFocus.value || showPropertyDetailsController.hasPhoneNumberInput.value
                    ? Text(
                  ...
                  left: showPropertyDetailsController.hasPhoneNumberInput.value
                      ? (showPropertyDetailsController.hasPhoneNumberFocus.value
                      ? AppSize.appSize16 : AppSize.appSize0)
                      : AppSize.appSize16,
                  bottom: showPropertyDetailsController.hasPhoneNumberInput.value
                      ? AppSize.appSize2 : AppSize.appSize2,
                ) : const SizedBox.shrink(),
                Row(
                  children: [
                    showPropertyDetailsController.hasPhoneNumberFocus.value || showPropertyDetailsController.hasPhoneNumberInput.value ? SizedBox(
                    ...
                    Expanded(
                      child: SizedBox(
                        ...
                        child: TextFormField(
                          readOnly: true,
                          focusNode: showPropertyDetailsController.phoneNumberFocusNode,
                          controller: showPropertyDetailsController.mobileNumberController,
                          ...
                          decoration: InputDecoration(
                            ...
                            isDense: true,
                            hintText: showPropertyDetailsController.hasPhoneNumberFocus.value ? '' : AppString.phoneNumber,
          ...
          Row(
            children: List.generate(showPropertyDetailsController.realEstateList.length, (index) {
              return GestureDetector(
                ...
                child: Obx(() => Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(AppSize.appSize12),
                    border: Border.all(
                      color: showPropertyDetailsController.selectAgent.value == index
                          ? AppColor.primaryColor.withOpacity(AppSize.appSizePoint50)
                          : AppColor.borderColor.withOpacity(AppSize.appSizePoint50),
                    ...
                    children: [
                      Stack(
                        children: [
                          ...
                          Positioned(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                showPropertyDetailsController.isSimilarPropertyLiked[index] =
                                !showPropertyDetailsController.isSimilarPropertyLiked[index];
                              },
                              child: Container(
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            showPropertyDetailsController.searchAddressList[index],
                            style: AppStyle.heading5Regular(color: AppColor.descriptionColor),
                          ).paddingOnly(top: AppSize.appSize6),
                        ],
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text(
                                showPropertyDetailsController.searchRatingList[index],
                                style: AppStyle.heading5Medium(color: AppColor.primaryColor),
                              ).paddingOnly(right: AppSize.appSize6),
                              Image.asset(
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: List.generate(showPropertyDetailsController.searchPropertyImageList.length, (index) {
                          return Container(
                            padding: const EdgeInsets.symmetric(
                            ...
                            child: Row(
                              children: [
                                Image.asset(
                                  showPropertyDetailsController.searchPropertyImageList[index],
                                  width: AppSize.appSize18,
                                  height: AppSize.appSize18,
                                ).paddingOnly(right: AppSize.appSize6),
                                Text(
                                  showPropertyDetailsController.similarPropertyTitleList[index],
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              physics: const ClampingScrollPhysics(),
              padding: const EdgeInsets.only(left: AppSize.appSize16),
              itemCount: showPropertyDetailsController.interestingImageList.length,
              itemBuilder: (context, index) {
                return Container(
                  width: AppSize.appSize300,
                  padding: const EdgeInsets.all(AppSize.appSize16),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              showPropertyDetailsController.interestingTitleList[index],
                              maxLines: AppSize.size3,
                              overflow: TextOverflow.ellipsis,
                              style: AppStyle.heading5Medium(color: AppColor.textColor),
                            ),
                            Text(
                              showPropertyDetailsController.interestingDateList[index],
