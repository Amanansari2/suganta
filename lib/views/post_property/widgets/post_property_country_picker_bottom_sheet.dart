...
import '../../../controller/post_property_country_picker_controller.dart';
import '../../../gen/assets.gen.dart';

postPropertyCountryPickerBottomSheet(BuildContext context) {
  PostPropertyCountryPickerController postPropertyCountryPickerController = Get.put(PostPropertyCountryPickerController());
          ...
          children: [
            Row(
              children: [
                Expanded(
                  child: TextFormField(
                    controller: postPropertyCountryPickerController.searchController,
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemCount: postPropertyCountryPickerController.flagsImageList.length,
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(postPropertyCountryPickerController.flagsImageList[index]),
