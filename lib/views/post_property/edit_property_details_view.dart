...
import '../../controller/edit_property_details_controller.dart';
import '../../gen/assets.gen.dart';

class EditPropertyDetailsView extends StatelessWidget {
  EditPropertyDetailsView({super.key});

  EditPropertyDetailsController editPropertyDetailsController = Get.put(EditPropertyDetailsController());
        ...
        bottom: PreferredSize(
          ...
          child: SizedBox(
            ...
            child: ListView(
              ...
              children: [
                Row(
                  children: List.generate(editPropertyDetailsController.propertyList.length, (index) {
                    return GestureDetector(
                      ...
                      child: Obx(() => Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border(
                            bottom: BorderSide(
                              color: editPropertyDetailsController.selectProperty.value == index
          ...
          children: [
            ...
            Obx(() => Container(
              padding:  EdgeInsets.only(
                top: editPropertyDetailsController.hasPhoneNumberFocus.value || editPropertyDetailsController.hasPhoneNumberInput.value
                    ? AppSize.appSize6 : AppSize.appSize14,
                bottom: editPropertyDetailsController.hasPhoneNumberFocus.value || editPropertyDetailsController.hasPhoneNumberInput.value
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: editPropertyDetailsController.hasPhoneNumberFocus.value || editPropertyDetailsController.hasPhoneNumberInput.value
                      ? AppColor.primaryColor
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  editPropertyDetailsController.hasPhoneNumberFocus.value || editPropertyDetailsController.hasPhoneNumberInput.value
                      ? Text(
                    ...
                    left: editPropertyDetailsController.hasPhoneNumberInput.value
                        ...
                        : AppSize.appSize16,
                    bottom: editPropertyDetailsController.hasPhoneNumberInput.value
                        ? AppSize.appSize2 : AppSize.appSize2,
                  ) : const SizedBox.shrink(),
                  Row(
                    children: [
                      editPropertyDetailsController.hasPhoneNumberFocus.value || editPropertyDetailsController.hasPhoneNumberInput.value ? SizedBox(
                      ...
                      Expanded(
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            controller: editPropertyDetailsController.mobileNumberController,
                            ...
                            decoration: InputDecoration(
                              ...
                              isDense: true,
                              hintText: editPropertyDetailsController.hasPhoneNumberFocus.value ? '' : AppString.phoneNumber,
            ...
            Row(
              children: List.generate(editPropertyDetailsController.propertyLookingList.length, (index) {
                return Expanded(
                  child: GestureDetector(
                    onTap: () {
                    ...
                    child: Obx(() => Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(AppSize.appSize12),
                        border: Border.all(
                          color: editPropertyDetailsController.selectPropertyLooking.value == index
                              ? AppColor.primaryColor
                              : AppColor.borderColor,
                          width: AppSize.appSize1,
                        ),
                      ...
                      child: Center(
                        child: Text(
                          editPropertyDetailsController.propertyLookingList[index],
                          style: AppStyle.heading5Medium(
                            color: editPropertyDetailsController.selectPropertyLooking.value == index
                                ? AppColor.primaryColor
                                : AppColor.descriptionColor,
            ...
            Row(
              children: List.generate(editPropertyDetailsController.propertyTypeList.length, (index) {
                return GestureDetector(
                  onTap: () {
                  ...
                  child: Obx(() => Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(AppSize.appSize12),
                      border: Border.all(
                        color: editPropertyDetailsController.selectPropertyType.value == index
                            ? AppColor.primaryColor
                            : AppColor.borderColor,
                        width: AppSize.appSize1,
                      ),
                ...
                return GestureDetector(
                  ...
                  child: Obx(() => Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(AppSize.appSize12),
                      border: Border.all(
                        color: editPropertyDetailsController.selectPropertyType2.value == index
                            ? AppColor.primaryColor
                    ...
                    child: Column(
                      ...
                      children: [
                        Image.asset(
                          editPropertyDetailsController.propertyTypeImageList[index],
